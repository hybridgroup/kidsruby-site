$(document).ready(function() {
	$.Juitter.start({
		...
		searchObject:"kidsruby", // needed, you can insert a username here or a word to be searched for, if you wish multiple search, separate the words by comma.
		...
		live:"live-150", // the number after "live-" indicates the time in seconds to wait before request the Twitter API for updates.
		...
		total: 8, // number of tweets to be show - max 100
